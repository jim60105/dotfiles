...
set directory=$USERPROFILE/dirs/tmp     " directory to place swap files in
set backup                        " make backup files
set backupdir=$USERPROFILE/dirs/backups " where to put backup files
set undofile                      " persistent undos - undo after you re-open the file
set undodir=$USERPROFILE/dirs/undos
set viminfo+=n$USERPROFILE/dirs/viminfo
" store yankring history file there too
"let g:yankring_history_dir = '$USERPROFILE/dirs'
